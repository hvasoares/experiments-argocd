...
- [X] T035 Tear down the local cluster: `kind delete cluster --name argocd-playground` (quickstart.md step 7) (depends on: T034) — torn down 2026-07-07 after the demo and doc set (002-repo-documentation) were complete.
